...
//        readers[2] = new Reader("Сидоров В.В.",3,"Менеджмент","09.01.1998","+380630000003");
        ...
        reader1.takeBook("Множественные умы Билли Миллигана, Дэниэл Киз", "Скотный Двор, Джордж Оруэл");
        reader1.takeBook(book1, book2,book3);


        reader1.returnBook(1);
        reader1.returnBook("Множественные умы Билли Миллигана, Дэниэл Киз");
        reader1.returnBook(book3);

//        books[2].PublicYear(),books[1].PublicYear(),books[0].PublicYear();
